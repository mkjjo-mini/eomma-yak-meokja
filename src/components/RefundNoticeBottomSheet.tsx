            ...
            <View style={styles.sheet} testID="refund-notice-sheet">
              ...
              <View style={styles.noticeSection} testID="refund-notice-text-section">
                ...
                <Text style={styles.noticeSubText}>
                  ...
                  <Text
                    style={styles.noticeLink}
                    onPress={() => void Linking.openURL('https://mkjjo-mini.github.io/eomma-yak-meokja/terms.html#refund')}
                    accessibilityRole="link"
              ...
              >
                ...
                <Text style={styles.checkboxLabel}>위 내용에 동의해요</Text>
              </TouchableOpacity>
              ...
              <View style={styles.buttonRow}>
                ...
                <TouchableOpacity
                  ...
                  disabled={!agreed}
                  accessibilityRole="button"
                  accessibilityLabel={agreed ? '결제하기' : '동의 후 결제하기'}
